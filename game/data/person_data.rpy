init python:
    ...
    person_genuses = ['junior', 'adolescent', 'mature', 'elder']
    ...
    core_homeworld_features = {
        'prehistoric': {'classes': ['hikikomori', 'soldier', 'slut', 'waiter', 'clerk'], 'slot': 'homeworld', 'name': __('Prehistoric world'), 'market_description': __(' из дикого, неразвитого мира, где люди крепки телом, но ещё не существует письменности'), 'might': 1, 'knowledge': -1, 'backgrounds': ['moron', 'tribesman', 'tribeswoman', 'brute', 'wisewoman', 'shaman', 'chiefwife', 'cheften', 'wildflower', 'amazon', 'epic_hero',]},
        'industrial': {'classes': ['hikikomori', 'soldier', 'slut', 'waiter', 'clerk'], 'slot': 'homeworld', 'name': __('Industrial world'), 'market_description': __('из индустриального мира, с развитой наукой но плохой экологией'), 'might': -1, 'knowledge': 1, 'backgrounds': ['beggar', 'vargant', 'moron',  'bitch', 'commoner', 'worker', 'housewife', 'soldier', 'whore', 'comander', 'ballerina', 'playboy', 'idol', 'epic_hero',]},
        'postapoc': {'classes': ['hikikomori', 'soldier', 'slut', 'waiter', 'clerk'], 'slot': 'homeworld', 'name': __('Postapocalyptic world'), 'market_description': __('из мира разрушенного катаклизмом, где подлость ценнее красоты'), 'subtlety': 1, 'charisma': -1, 'backgrounds': ['beggar', 'vargant', 'bitch', 'tribesman', 'tribeswoman', 'brute', 'wisewoman', 'shaman', 'chiefwife', 'cheften', 'amazon',  'epic_hero',]},
        'utopia': {'classes': ['hikikomori', 'soldier', 'slut', 'waiter', 'clerk'], 'slot': 'homeworld', 'name': __('Utopic world'), 'market_description': __('из счастливой утопической цивилизации, где ценится красота но люди бесхитростны и наивны'), 'subtlety': -1, 'charisma': 1, 'backgrounds': ['moron', 'commoner', 'nerd', 'muse', 'model', 'atlete', 'fitgirl', 'poet', 'vigilante', 'opinion_leader', 'epic_hero']},
    }
