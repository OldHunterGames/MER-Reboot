...
label lbl_storylanista_actionanalysis:
    ...
    phoenix 'Во-первых, обучение послендовательное. Ты не можешь сразу воспитать гоплинию, например. Сначала рабыне придётся освоить класс луктатора, потом андабанда и уже дальше откроется потенциал для гоплинии.'
    ...
    phoenix 'Теперь про отработку тактики. Ты можешь применить собственный боевой опыт, чтобы подсказать своему гладиатору оптимальный способ действий в слендующем бою. Он получит карту "тактики", масть крести, достоинство зависит от твоего уровня.'
    ...
    phoenix 'Если отправить на равзлечение однополую пару, то они будут укреплять дружбу, а если мужчину и женщину то они наверняка займутся любовью. Только будь осторожен - уже имеюшимся любовникам и друзьям это может не понравиться.'
    ...
    phoenix 'Только помни, что в отличие от карт класса, карты боевого духа будут действены только в следующем бою - потом они исчезнут, даже если ты не применишь их в бою.'
