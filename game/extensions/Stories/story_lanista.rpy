...
label lbl_storylanista_lupaintro:
    ...
    player 'И если моя рабыня победит, я получу нагрду?'
...
label lbl_storylanista_colintro:
    ...
    redsonya 'Воу, придержи коней, "ланиста". Сначала я допущу тебя до схавток на разогреве. Если покажешь себя там, то дам шанс в главных боях.'
...
label lbl_storylanista_colquestions:
    menu:
        'Как работает боевая система?':
            ...
            redsonya 'Она сгорит и потрятится зря, а ты продолжишь отбиваться пока у кого-то из вас не кончасться карты.'
            player 'И что если они кончатся у меня?'
            redsonya 'Тогда ты проиграл.'
            redsonya 'А как же понять какая карта сильнее а какая слабее?'
            ...
            redsonya 'У боевых карт есть достоинство, по взрастанию старшинства это красный < фиолетовый < циан < синий < зелёный < золотой.'
            ...
            redsonya 'Самая слабая масть - черепа. Карта любой другой масть побьёт череп, какое бы достоинство он не имел.'
            player 'Даже красная бубна может побить золотой череп?!'
            redsonya 'Да. Именно так. Черепа отстой. Используй их только против других черепов с достоинством по младше. Это всё на что они годятся.'
            ...
            redsonya 'Это условности. Просто так легче запомнить: черви > трефы > пики > черви. Любовь > Мудрость > Предательство > Любовь.'
            player 'Ух. Постараюсь запомнить...'
            redsonya 'Постарайся. Это самое важное.'
            redsonya 'Теоретически (не думаю что тебе пригодится) есть ещё джокеры. Они бывают только красные и золотые. Твой всегда золтой, у врага всегда красный.'
        ...
        'Я проигрываю даже если мы равны!':
            redsonya 'Да. Для победы тебе нужно побить каждую карту врага. И сели у тебя меньше карт или хотя бы одну карту врага нечем крыть - ты обречен.'
            ...
            redsonya 'Если братаны и сеструхи пойдут вместе, они вместе получат бонус братства и подружатся. Если отправишь мужчину и женшщину, не удивляйся что они станут любовниками.'
            redsonya 'Оба любовника так же получат бонусы. Только достоинство карты будет зависит от параметров любовника. Чем больше харизма партнёра, тем старше будет карта удовлетворения.'
            ...
            redsonya 'Конечно сам ты можешь спать или тусить с кем угодно без последствий, но вот если дать рабам повод для сооры...'
            ...
            player 'Это как?'
            redsonya 'В битве у врага ВНЕЗАПНО появится карта "предательсва". И тебе придётся побить ещё и её ко всему в предачу.'
        ...
        'Напомни мне про старшинство карт.':
            ...
            redsonya 'Черви сильнее чем крести, но боятся пик. Пирка пронзает сердце!'
