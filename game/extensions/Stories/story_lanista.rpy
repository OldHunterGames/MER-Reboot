...
label lbl_storylanista_luctatorbang(context):
    ...
    'У входа на ринг мгновенно образуется очередь из возбуждённых битвой посетителей. Полуобнажённая прислужница принимает у них по одной Искре и пропускает внутрь.'
...
label lbl_storylanista_slavesex(context):
    ...
    'Чувствя мой оргазм гладиаторша крепко охватывает меня руками и ногами, максимально прижима к своему покрытому свежим потом телу.'
    glad 'Аааах...'
    show black with dissolve
